...
final public class TextForegroundColorPickerViewController: SwiftColorPickerViewController {
    
}
final public class TextBackgroundColorPickerViewController: SwiftColorPickerViewController {
 ...
 public class SwiftColorPickerViewController: UIViewController
{
    ...
    public override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItems = [UIBarButtonItem(title:" B ",style:.Plain,target:self,action:"hitB"),
        UIBarButtonItem(title:" w ",style:.Plain,target:self,action:"hitW")]
